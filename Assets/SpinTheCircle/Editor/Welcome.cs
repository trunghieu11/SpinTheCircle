...
namespace AppAdvisory.SpinTheCircle
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/DontFall/Documentation/html/annotated.html";
		private const string RATEUS_URL = "http://u3d.as/rtL";

		private const string NAME_OF_THE_GAME = "Spin The Circle";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
